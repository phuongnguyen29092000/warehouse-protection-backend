...
const emailResetPassword = async(email, token) =>{
    const resetPasswordUrl = `${process.env.BASE_URL_FRONTEND}/dat-lai-mat-khau?token=${token}`;
    transporter.sendMail({
        ...
        Hạn đặt lại mật khẩu sẽ hết hạn lúc: ${moment().add(parseInt(process.env.RESET_PASSWORD_EXPIRATION_MINUTES), 'minutes').format('YYYY-MM-DD LTS')}
